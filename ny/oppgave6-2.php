...
<h3>Skjema</h3>
    ...
    <form action="" method="post" style="display:block">
            ...
            <label for="fagkode">Fagkode</label><input type="text" name="fagkode" id="fagkode" />
            <label for="fagnavn">Fagnavn</label><input type="text" name="fagnavn" id="fagnavn" />
            <label for="faglarer">Faglærer</label><input type="text" name="faglarer" id="faglarer" />
